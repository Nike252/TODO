// import bg from 'd:/CDL/ToDo/Frontend/src/Images/Green BG.jpg';
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 flex justify-center space-x-3">
            {['Buy milk', 'Call mom', 'Finish project'].map((task, i) => (
              <div 
                key={i}
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 mt-1">Sign in to manage your tasks</p>
            </div>
            ...
            {/* Google Sign In */}
            <button
              className="w-full flex items-center justify-center gap-3 py-2.5 px-4 border rounded-lg text-sm font-medium text-gray-700 hover:shadow-sm transition-all mb-6"
